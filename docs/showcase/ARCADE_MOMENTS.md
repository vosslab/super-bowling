...
frames keep individual reactions large, while the ten-pin view makes the rolling ball, physical
aftermath, and earned result unmistakable. The record and handoff frames show how the game returns
from impact to useful player information.
